 ...
 * C2S: 近战请求。
 */
public class ClientMessagePlayerMelee() : IMessage, IMessageHandler<ClientMessagePlayerMelee, IMessage?> {

    override fun fromBytes(buf: ByteBuf) {}
    override fun toBytes(buf: ByteBuf) {}

    override fun onMessage(message: ClientMessagePlayerMelee, ctx: MessageContext): IMessage? {
