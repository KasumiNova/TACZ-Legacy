...
/**
 * Wrapper around BedrockPart providing getter/setter API for
 * rotation, offset, scale, visibility, quaternion.
 * Direct port from upstream TACZ ModelRendererWrapper.
 */
